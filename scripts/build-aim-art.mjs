...
await sharp(`${root}source-art/training/select-aim.png`).extract({left:8,top:350,width:1520,height:260}).resize({width:768,kernel:'lanczos3'}).png().toFile(`${dir}/select.png`);
