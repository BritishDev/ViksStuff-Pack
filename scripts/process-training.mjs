...
await writeFile(`${fonts}/training_clutch.json`, JSON.stringify({providers:[
  provider('pending','\uE103',16,1),provider('hit','\uE104',16,1),provider('miss','\uE105',16,1),
  provider('frame','\uE106',22,4),{type:'space',advances:{'\uE107':-176,'\uE108':5}}
]},null,2));
...
const frame = `<svg width="720" height="88" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="rim" x2="0" y2="1"><stop stop-color="#ff7777"/><stop offset=".35" stop-color="#ed182c"/><stop offset="1" stop-color="#660817"/></linearGradient></defs><rect x="2" y="2" width="716" height="84" rx="13" fill="#030202" stroke="url(#rim)" stroke-width="4"/><rect x="7" y="7" width="706" height="74" rx="9" fill="none" stroke="#420a12" stroke-width="2"/></svg>`;
